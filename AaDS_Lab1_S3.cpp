...
#pragma endregion
	...
	cout << side_List;
	cout << "its size: ";
	cout << side_List.size()<< endl;

	//output of the final function
	i = newList.find_first(side_List);
