...
{
	if (index < 0) { Node* current = head; head = current->getNext(); }
	else
	{
		Node* current = head; int i = 1;
		Node* previous = NULL;
...
int List::find_first(List& side_list)
{
	Node* current = head; int i = 1; int entry_count, compleat_count = 0;
